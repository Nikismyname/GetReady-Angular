...
export class GlobalSheetComponent {
    ...
    questionSheet$: Observable<QsGlobalIndex>;
    ...
    onDroppedSheets(orderings) {
        let data: IQuestionReorder = { orderings: orderings, sheetId: this.currentSheetId };
        this.store.dispatch(new GlobalSheetActions.sheetReorder(data));
    }
